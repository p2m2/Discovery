...
object SimpleConsoleTest extends TestSuite {
  def tests = Tests {
    test("get String") {
      ...
      assert(SimpleConsole.get(NotEqual("h",true)) != "")
      assert(SimpleConsole.get(StrStarts("h",true)) != "")
      assert(SimpleConsole.get(StrEnds("h",true)) != "")
      assert(SimpleConsole.get(Inf("0.5",true)) != "")
      assert(SimpleConsole.get(InfEqual("0.5",true)) != "")
      assert(SimpleConsole.get(Sup("0.5",true)) != "")
